...
async def main():
    """Main entry point — Render compatible with stable keep-alive"""
    logger.info("=" * 50)
    logger.info("🚀 Starting Bot...")

    # Start health server FIRST as background task
    ...
    # 🔥 FIX #5 — Better than asyncio.Event().wait()
    # Render stable keep-alive, no event starvation
    # Handlers always active
